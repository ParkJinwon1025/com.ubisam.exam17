...
public class DriverHandler {
    ...
    @HandleBeforeRead
    public void handleBeforeRead(Driver e, Specification<Driver> spec) throws Exception {
        // 로그 코드 작성
        ...
        query.where()
                .and().eq("driverName", e.getSearchName())
                .and().eq("driverLicenseNumber", e.getSearchLicenseNumber())
                .and().eq("driverCareerYears", e.getSearchCareerYears())
                .build(spec);
    }

    @HandleAfterRead
    public void afterRead(Driver e, Serializable r) throws Exception {
        // 로그 코드 작성 (Auditing)
    ...
    @HandleBeforeCreate
    public void beforeCreate(Driver e) throws Exception {
        // 로그 코드 작성 (Auditing)
        // 테스트에서는 sysout으로 작성하나 실제는 log 사용
    ...
    @HandleBeforeSave
    public void beforeSave(Driver e) throws Exception {
        // 로그 코드 작성 (Auditing)
        // 테스트에서는 sysout으로 작성하나 실제는 log 사용
    ...
    @HandleBeforeDelete
    public void beforeDelete(Driver e) throws Exception {
        // 로그 코드 작성 (Auditing)
        // 테스트에서는 sysout으로 작성하나 실제는 log 사용
    ...
    @HandleAfterCreate
    public void afterCreate(Driver e) throws Exception {
        // 로그 코드 작성 (Auditing)
        // 테스트에서는 sysout으로 작성하나 실제는 log 사용
    ...
    @HandleAfterSave
    public void afterSave(Driver e) throws Exception {
        // 로그 코드 작성 (Auditing)
        // 테스트에서는 sysout으로 작성하나 실제는 log 사용
    ...
    @HandleAfterDelete
    public void afterDelete(Driver e) throws Exception {
        // 로그 코드 작성 (Auditing)
        // 테스트에서는 sysout으로 작성하나 실제는 log 사용
